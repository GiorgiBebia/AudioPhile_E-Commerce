export const products = [
  {
    ...
    inTheBox: [
      ...
      { name: "Replacment Earcups", quantity: 2 },
      { name: "User Manual", quantity: 1 },
      { name: "3.5mm 5m Audio Cable", quantity: 1 },
      { name: "Travel Bag", quantity: 1 },
    ],
    firstImg: "img/xx99Mark2.png",
    tabletImg: "img/tabletXX99Mark2Detail.png",
    mobileImg: "img/mobileXX99Mark2Detail.png",
    secondImg: "img/xx99Mark2Second.png",
    thirdImg: "img/xx99Mark2Third.png",
    fourImg: "img/xx99Mark2Four.png",
    cartName: "XX99 MARK II",
    totalPrice: 0,
    cartImg: "img/xx99Mark2.png",
  },
  {
    id: 2,
    ...
    firstImg: "img/xx99Mark1.png",
    tabletImg: "img/tabletXX99Mark1Detail.png",
    mobileImg: "img/mobileXX99Mark1Detail.png",
    secondImg: "img/xx99Mark1Second.png",
    thirdImg: "img/xx99Mark1Third.png",
    fourImg: "img/xx99Mark1Four.png",
    cartName: "XX99 MARK I",
    totalPrice: 0,
    cartImg: "img/xx99Mark1.png",
  },
  {
    id: 3,
    ...
    firstImg: "img/xx59Headphones.png",
    tabletImg: "img/tabletXX59HeadphonesDetail.png",
    mobileImg: "img/mobileXX59HeadphonesDetail.png",
    secondImg: "img/xx59HeadphonesSecond.png",
    thirdImg: "img/xx59HeadphonesThird.png",
    fourImg: "img/xx59HeadphonesFour.png",
    cartName: "XX59",
    totalPrice: 0,
    cartImg: "img/xx59Headphones.png",
  },
  {
    id: 4,
    name: "ZX9 SPEAKER",
    ...
    inTheBox: [
      ...
      { name: "Speaker Cloth Panel", quantity: 2 },
      { name: "User Manual", quantity: 1 },
      { name: "3.5mm 10m Audio Cable", quantity: 1 },
      { name: "10m Optical Cable", quantity: 1 },
    ],
    // firstImg: "img/zx9Speaker.png",
    firstImg: "img/zx9SpeakerSpeakers.png",
    tabletImg: "img/tabletZX9SpeakerDetail.png",
    mobileImg: "img/mobileZX9SpeakerDetail.png",
    secondImg: "img/zx9SpeakerSecond.png",
    thirdImg: "img/zx9SpeakerThird.png",
    fourImg: "img/zx9SpeakerFour.png",
    cartName: "ZX9",
    totalPrice: 0,
    cartImg: "img/zx9SpeakerSpeakers.png",
  },
  {
    id: 5,
    name: "ZX7 SPEAKER",
    ...
    inTheBox: [
      ...
      { name: "Speaker Cloth Panel", quantity: 2 },
      { name: "User Manual", quantity: 1 },
      { name: "3.5mm 7.5m Audio Cable", quantity: 1 },
      { name: "7.5m Optical Cable", quantity: 1 },
    ],
    firstImg: "img/zx7SpeakerSpeakers.png",
    tabletImg: "img/tabletZX7SpeakerDetail.png",
    mobileImg: "img/mobileZX7SpeakerDetail.png",
    secondImg: "img/zx7SpeakerSecond.png",
    thirdImg: "img/zx7SpeakerThird.png",
    fourImg: "img/zx7SpeakerFour.png",
    cartName: "ZX7",
    totalPrice: 0,
    cartImg: "img/zx7SpeakerSpeakers.png",
  },
  {
    id: 6,
    ...
    inTheBox: [
      { name: "Earphone Unit", quantity: 2 },
      { name: "Multi-size Earplugs", quantity: 6 },
      { name: "User Manual", quantity: 1 },
      { name: "USB-C Charging Cable", quantity: 1 },
      { name: "Travel Pouch", quantity: 1 },
    ],
    firstImg: "img/yx1WirelessEarphones.png",
    tabletImg: "img/tabletYX1WirelessDetail.png",
    mobileImg: "img/mobileYX1WirelessDetail.png",
    secondImg: "img/yx1WirelessEarphonesSecond.png",
    thirdImg: "img/yx1WirelessEarphonesThird.png",
    fourImg: "img/yx1WirelessEarphonesFour.png",
    cartName: "YX1",
    totalPrice: 0,
    cartImg: "img/yx1WirelessEarphones.png",
  },
];
