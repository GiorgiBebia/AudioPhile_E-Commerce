...
export function Footer() {
  return (
    <div className="mt-[200px] tablet:mt-[96px] max-w-[1440px] tablet:max-w-[768px] mobile:max-w-[375px] w-full h-[365px] tablet:h-[400px] mobile:h-[654px] bg-black ">
      <div className="max-w-[1110px] w-full flex flex-col pl-[165px] tablet:pl-[39px] mobile:pl-0">
        ...
        <p className="w-[540px] tablet:w-[689px] mobile:w-[327px] h-[100px] tablet:h-[75px] mobile:h-[150px] font-manrope text-[15px] text-gray-500 mt-[36px] tablet:mt-[32px] mobile:mt-[48px] mobile:mx-auto mobile:text-center">
