...
export function Header() {
  ...
  return (
    <div className="w-full h-[729px] bg-[url('/img/headerBackground.png')] tablet:bg-[url('/img/tabletHeaderBackground.png')] mobile:bg-[url('/img/mobileHeaderBackground.png')] bg-black">
      <HeaderNav />
