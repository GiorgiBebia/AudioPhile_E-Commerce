...
export function CheckoutMain({ setOrderConfirmed }) {
  ...
  return (
    <div className="max-w-[1110px] tablet:max-w-[689px] w-full h-[1126px] tablet:h-[1805px] mx-auto mt-[38px] flex gap-[30px] tablet:flex-col">
      <div className="w-[730px] tablet:w-[689px] mobile:w-[327px] h-[1126px] tablet:h-[1084px] mobile:h-[1400px] bg-white flex flex-col justify-evenly pl-[48px] tablet:pl-[27.5px] mobile:pl-[24px] rounded-[8px] mobile:mx-auto mobile:pt-[24px] mobile:pb-[30px]">
        ...
        <div className="flex flex-col gap-[24px] mobile:w-[280px] mobile:h-[332px] mobile:flex-col tablet:mt-[20px] mobile:mt-[32px]">
          ...
          <div className="flex gap-[16px] mobile:flex-col">
            <div className="flex flex-col gap-[9px]">
              ...
              <input
                ...
                }  rounded-[8px] placeholder:font-manrope placeholder:font-bold p-[24px] hover:border-[#D87D4A]`}
                type="text"
                name="fullName"
                id="fullName"
          ...
          <div className="flex flex-col gap-[9px]">
            ...
            <input
              ...
              } rounded-[8px] placeholder:font-manrope placeholder:font-bold p-[24px] hover:border-[#D87D4A] [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none`}
              type="number"
              name="phoneNumber"
              id="phoneNumber"
              placeholder="598 12 34 56"
              value={phoneNumber}
        ...
        <div className="flex flex-col gap-[24px] mobile:w-[280px] mobile:h-[437px] tablet:mt-[20px] mobile:mt-[32px]">
          ...
          <div className="flex gap-[16px] mobile:flex-col">
            <div className="flex flex-col gap-[9px]">
              ...
              <input
                className="w-[309px] mobile:w-[280px] h-[56px] border border-[#CFCFCF] rounded-[8px] placeholder:font-manrope placeholder:font-bold p-[24px] hover:border-[#D87D4A] [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
                type="number"
                name="zipCode"
                id="zipCode"
                placeholder="10001"
            ...
            <div className="flex flex-col gap-[9px]">
              ...
              <input
                className="w-[309px] mobile:w-[280px] h-[56px] border border-[#CFCFCF] rounded-[8px] placeholder:font-manrope placeholder:font-bold p-[24px] hover:border-[#D87D4A]"
                type="text"
                name="city"
                id="city"
        ...
        <div className="flex flex-col gap-[24px] mobile:w-[280px] mobile:h-[420px] tablet:mt-[20px] mobile:mt-[32px]">
          ...
          <div className="flex gap-[229px] mobile:gap-[16px] mobile:flex-col">
            ...
            <div className="w-[309px] mobile:w-[280px] h-[128px] flex flex-col gap-[16px]">
              <div className="w-[309px] mobile:w-[280px] h-[56px] border border-[#CFCFCF] rounded-[8px] p-4 flex items-center hover:border-[#D87D4A]">
                <input
                  className="w-[20px] h-[20px] accent-[#D87D4A]"
                  type="radio"
                  name="payment"
                  id="emoney"
                  defaultChecked
          ...
          {paymentEmoney ? (
            ...
            <div className="flex w-[634px] h-[75px] gap-[32px] items-center mobile:flex-col">
              <img
                className="w-[48px] h-[48px]"
                src="img/cashOnDelivery.png"
                alt=""
              />
              <p className="font-manrope text-[15px] text-gray-500 w-[520px] tablet:mb-[25px] mobile:w-[280px]">
